...
function App() {
    ...
    return (_jsx(Router, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "/auth/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/auth/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { path: "/auth/verify-email", element: _jsx(VerifyEmailPage, {}) }), _jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/groups/:groupId", element: _jsx(GroupPage, {}) }), _jsx(Route, { path: "/groups/:groupId/setlists", element: _jsx(SetlistsPage, {}) }), _jsx(Route, { path: "/groups/:groupId/setlists/:setlistId", element: _jsx(SetlistPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/" }) })] }) }));
}
export default App;
