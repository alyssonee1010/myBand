...
export default function GroupPage() {
    ...
    const handleEditContent = async (contentId, title, description) => {
        const updatedContent = await contentApi.updateContentDetails(groupId, contentId, title, description);
