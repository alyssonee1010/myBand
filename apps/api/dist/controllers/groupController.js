 ...
 */
export const inviteMemberToGroup = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { groupId } = req.params;
 ...
 */
export const revokeGroupInvitation = asyncHandler(async (req, res) => {
    const userId = req.userId;
...
export const acceptGroupInvitation = asyncHandler(async (req, res) => {
    ...
    const canAcceptInvitation = invitation.inviteeId === userId ||
 ...
 */
export const getGroupJoinLink = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { groupId } = req.params;
    if (!userId) {
        throw new ApiError(401, 'Unauthorized');
 ...
 */
export const createOrRegenerateGroupJoinLink = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { groupId } = req.params;
    if (!userId) {
        throw new ApiError(401, 'Unauthorized');
 ...
 */
export const disableGroupJoinLink = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { groupId } = req.params;
    if (!userId) {
        throw new ApiError(401, 'Unauthorized');
