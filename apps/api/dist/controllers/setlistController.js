 ...
 */
export const createSetlist = asyncHandler(async (req, res) => {
 ...
 */
export const getGroupSetlists = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { groupId } = req.params;
    if (!userId) {
        throw new ApiError(401, 'Unauthorized');
 ...
 */
export const getSetlist = asyncHandler(async (req, res) => {
    const userId = req.userId;
 ...
 */
export const addItemToSetlist = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { setlistId } = req.params;
 ...
 */
export const reorderSetlistItems = asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { setlistId } = req.params;
 ...
 */
export const removeItemFromSetlist = asyncHandler(async (req, res) => {
    const userId = req.userId;
...
//# sourceMappingURL=setlistController.js.map